...
budget when the get they compute the total.  

Shopping Cart Program! Hope you enjoy!
...
while True:
    ...
    "5. Add a budget\n"
    "6. Quit")
    option = input("Please choose a menu option 1-6: ")
    print("")
    ...
    # 4. Compute the total
        ...
        if budget > 0:
            if shopping_cart_total > budget:
                print(f"You are over your budget by ${shopping_cart_total - budget:.2f}")
            else:
                print(f"You are within your budget with ${budget - shopping_cart_total:.2f} remaining.")
        else:
            print("No budget has been added.")
            print("")
    # 5. Add a budget
    elif option == "5":
    ...
    # Any other incorrect input
        ...
        print("Invalid. Please select a number 1-6.")
        print("")
